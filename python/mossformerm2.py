...
from mossformerblock import MossformerBlock_MLX

class MossFormerM2_MLX(nn.Module):
    """
    ...
    Example:
        ...
        >>> net = MossFormerM2_MLX(num_blocks=8, d_model=512)
        >>> output = net(x)
    ...
    def __init__(
        ...
        self.mossformerM = MossformerBlock_MLX(
            dim=d_model,
            depth=num_blocks,
